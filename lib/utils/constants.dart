const String kPrefsFavorites = 'favorites';
const String kPrefsThemeMode = 'theme_mode';
const String kPrefsLangOrder = 'lang_order';
const String kPrefsFontSize = 'font_size';
const String kPrefsNotifEnabled = 'notif_enabled';
const String kPrefsNotifTime = 'notif_time';
